...
return array(
    ...
    'auth_cognito\\local\\audiences' => $baseDir . '/classes/local/audiences.php',
    'auth_cognito\\local\\courses' => $baseDir . '/classes/local/courses.php',
    'auth_cognito\\local\\groups' => $baseDir . '/classes/local/groups.php',
    'auth_cognito\\local\\messages' => $baseDir . '/classes/local/messages.php',
    'auth_cognito\\local\\token' => $baseDir . '/classes/local/token.php',
    'auth_cognito\\local\\user' => $baseDir . '/classes/local/user.php',
    'auth_cognito\\privacy\\provider' => $baseDir . '/classes/privacy/provider.php',
);
